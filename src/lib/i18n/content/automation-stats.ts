export const automationStatsContent = {
  pt: {
    ...
    crossingAbsenceAutoActive: "Automático: média {{spins}} giros por mesa (máx. {{max}} +2 na janela de 50 giros)",
    crossingAbsenceAutoOn: "Modo automático — gatilho = máx. ausência na janela + 2 giros, por mesa.",
    crossingAbsencePerTableTitle: "Gatilho por roleta",
    crossingAbsencePerTableHint:
      "Cada linha mostra a máx. ausência na janela (últimos 50 giros) e o gatilho efectivo (máx. + 2) por mesa. Valores em verde = modo automático activo nesse eixo.",
  ...
  en: {
    ...
    crossingAbsenceManual: "Manual",
    crossingAbsenceAutoActive: "Automatic: {{spins}} spins avg per table (max {{max}} +2 in 50-spin window)",
    crossingAbsenceAutoOn: "Automatic mode — trigger = max absence in window + 2 spins, per table.",
    crossingAbsencePerTableTitle: "Trigger per table",
    crossingAbsencePerTableHint:
      "Each row shows max absence in the window (last 50 spins) and the effective trigger (max + 2) per table. Green values = automatic mode on that axis.",
  ...
  es: {
    ...
    crossingAbsenceAuto: "Automático",
    crossingAbsenceManual: "Manual",
    crossingAbsenceAutoActive: "Automático: media {{spins}} giros por mesa (máx. {{max}} +2 en ventana de 50 giros)",
    crossingAbsenceAutoOn: "Modo automático — gatillo = máx. ausencia en ventana + 2 giros, por mesa.",
    crossingAbsencePerTableTitle: "Gatillo por mesa",
    crossingAbsencePerTableHint:
      "Cada fila muestra la máx. ausencia en ventana (últimos 50 giros) y el gatillo efectivo (máx. + 2) por mesa. Valores en verde = modo automático activo en ese eje.",
    crossingAbsenceColTable: "Mesa",
