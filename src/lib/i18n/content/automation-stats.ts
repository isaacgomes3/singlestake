export const automationStatsContent = {
  pt: {
    ...
    crossingAbsenceAutoActive: "Automático: média {{spins}} giros por mesa (máx. {{max}} +2 na janela de 60 giros)",
    ...
    crossingAbsencePerTableHint:
      "Cada linha mostra a máx. ausência na janela (últimos 60 giros) e o gatilho efectivo (máx. + 2) por mesa. Valores em verde = modo automático activo nesse eixo.",
  ...
  en: {
    ...
    crossingAbsenceManual: "Manual",
    crossingAbsenceAutoActive: "Automatic: {{spins}} spins avg per table (max {{max}} +2 in 60-spin window)",
    ...
    crossingAbsencePerTableHint:
      "Each row shows max absence in the window (last 60 spins) and the effective trigger (max + 2) per table. Green values = automatic mode on that axis.",
  ...
  es: {
    ...
    crossingAbsenceAuto: "Automático",
    crossingAbsenceManual: "Manual",
    crossingAbsenceAutoActive: "Automático: media {{spins}} giros por mesa (máx. {{max}} +2 en ventana de 60 giros)",
    ...
    crossingAbsencePerTableHint:
      "Cada fila muestra la máx. ausencia en ventana (últimos 60 giros) y el gatillo efectivo (máx. + 2) por mesa. Valores en verde = modo automático activo en ese eje.",
    crossingAbsenceColTable: "Mesa",
