export const automationStatsContent = {
  pt: {
    ...
    crossingAbsenceAutoActive: "Automático: média {{spins}} giros por mesa (máx. {{max}} na janela)",
    crossingAbsenceAutoOn: "Modo automático — cada mesa usa a sua própria ausência na janela.",
    crossingAbsencePerTableTitle: "Gatilho por roleta",
    crossingAbsencePerTableHint:
      "Cada linha mostra a máx. ausência na janela (últimos 50 giros) e o gatilho efectivo por mesa. Valores em verde = modo automático activo nesse eixo.",
  ...
  en: {
    ...
    crossingAbsenceManual: "Manual",
    crossingAbsenceAutoActive: "Automatic: {{spins}} spins avg per table (max {{max}} in window)",
    crossingAbsenceAutoOn: "Automatic mode — each table uses its own absence in the window.",
    crossingAbsencePerTableTitle: "Trigger per table",
    crossingAbsencePerTableHint:
      "Each row shows max absence in the window (last 50 spins) and the effective trigger per table. Green values = automatic mode on that axis.",
  ...
  es: {
    ...
    crossingAbsenceAuto: "Automático",
    crossingAbsenceManual: "Manual",
    crossingAbsenceAutoActive: "Automático: media {{spins}} giros por mesa (máx. {{max}} en ventana)",
    crossingAbsenceAutoOn: "Modo automático — cada mesa usa su propia ausencia en ventana.",
    crossingAbsencePerTableTitle: "Gatillo por mesa",
    crossingAbsencePerTableHint:
      "Cada fila muestra la máx. ausencia en ventana (últimos 50 giros) y el gatillo efectivo por mesa. Valores en verde = modo automático activo en ese eje.",
    crossingAbsenceColTable: "Mesa",
