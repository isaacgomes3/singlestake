...
import {
  ...
  spin24dFactorLabel,
  spin24dSharedFactorsBetween,
  spin24dTriggerMatchCount,
} from "@/lib/roulette/spin24dFactors";
import {
...
import { umFatorOppositeFactor } from "@/lib/roulette/umFatorStrategy";
...
export const ICE_2F_RECOVERY_BET_DELAY_MS = 9_500;
...
export function tickIce2fPlacar(
  ...
  // Após W/L/empate: NÃO rearma no mesmo giro.
  // Rearmar no head do liquidar repete o match 2×4 do histórico →
  // mesma indicação no painel sem gatilho novo e sem janela de clique fiável.
  if (
    !flash &&
    !nextMachine.cycle &&
    headChanged &&
