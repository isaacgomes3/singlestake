...
var SinglestakeIce2f = (() => {
  ...
  var ice2f_strategy_entry_exports = {};
  __export(ice2f_strategy_entry_exports, {
  ...
  var ICE2F_TABLE_ID = ICE_2F_ROULETTE_TABLE_ID;
  var ICE2F_MESA_URL = ICE_2F_ROULETTE_MESA_URL;
  var ICE2F_MAX_GALES = ICE_2F_MAX_RECOVERY;
  ...
  function createIce2fEngine(options = {}) {
    ...
    if (options.initialMachine) {
      ...
      machine = {
        ...
        gatePairId: typeof saved.gatePairId === "string" && ICE2F_PAIR_IDS.has(saved.gatePairId) ? saved.gatePairId : machine.gatePairId,
    ...
    function ingestHistorySnapshot(spins) {
      ...
      if (preservedCycle?.phase === "awaiting_result") {
        ...
        const locked = typeof pendingRestore.lockedPosition === "number" && ICE2F_POSITIONS.has(pendingRestore.lockedPosition) ? pendingRestore.lockedPosition : null;
        ...
        const gatePairId = typeof pendingRestore.gatePairId === "string" && ICE2F_PAIR_IDS.has(pendingRestore.gatePairId) ? pendingRestore.gatePairId : machine.gatePairId;
        pendingRestore = null;
        machine = {
          ...machine,
          nextEntryAxis: axis,
    ...
    function buildBridgePayload(mesaEmbedUrl = ICE2F_MESA_URL) {
      ...
      return {
        ...
        context: {
          sessionMode: "active",
          prepareTableId: null,
          currentTableId: ICE2F_TABLE_ID,
          mesaEmbedUrl: mesaEmbedUrl ?? ICE2F_MESA_URL,
          mesaProvider: "outro",
  ...
  if (typeof globalThis !== "undefined") {
    globalThis.SinglestakeIce2f = api;
  }
  var ice2f_strategy_entry_default = api;
  return __toCommonJS(ice2f_strategy_entry_exports);
})();
