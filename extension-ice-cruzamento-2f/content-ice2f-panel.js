...
function pageIsIce2fRoulette() {
  ...
  style.textContent = `
    ...
    #${PANEL_ID} .ss-ice2f-pair-row.off .ss-ice2f-pair-id { color: #64748b; }
    #${PANEL_ID} .ss-ice2f-pair-enable {
      position: relative;
      width: 34px;
      height: 18px;
      flex-shrink: 0;
    }
    #${PANEL_ID} .ss-ice2f-pair-enable input {
      opacity: 0;
      width: 0;
      height: 0;
    }
    #${PANEL_ID} .ss-ice2f-pair-enable .ss-ice2f-slider {
      position: absolute;
      inset: 0;
      background: #334155;
      border-radius: 999px;
    ...
    #${PANEL_ID} .ss-ice2f-pair-enable .ss-ice2f-slider::before {
      content: "";
      position: absolute;
      width: 14px;
      height: 14px;
    ...
    #${PANEL_ID} .ss-ice2f-pair-enable input:checked + .ss-ice2f-slider {
      background: #15803d;
    }
    #${PANEL_ID} .ss-ice2f-pair-enable input:checked + .ss-ice2f-slider::before {
    ...
    #${PANEL_ID} .ss-ice2f-pair-head .ss-ice2f-pair-bad,
    #${PANEL_ID} .ss-ice2f-pair-head .ss-ice2f-pair-en {
      color: #64748b;
      text-align: center;
    }
  ...
  const pairTitle = el("div", "ss-ice2f-pair-title", "Gatilho (OK/ERR · activar)");
  const pairBoard = el("div", "ss-ice2f-pairs");
  const pairHead = el("div", "ss-ice2f-pair-head");
  pairHead.append(
    el("span"),
    el("span", "ss-ice2f-pair-en", "ON"),
    el("span", "ss-ice2f-pair-ok", "OK"),
    el("span", "ss-ice2f-pair-bad", "ERR"),
  );
  ...
  function renderStatus(data) {
    ...
    const enabledSet = new Set(
      Array.isArray(st.enabledPairIds) && st.enabledPairIds.length > 0
        ? st.enabledPairIds
        : Array.isArray(data.ice2fConfig?.enabledPairIds)
          ? data.ice2fConfig.enabledPairIds
          : ["2x4"],
    );
