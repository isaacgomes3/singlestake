...
function pageIsReals2fRoulette() {
  ...
  style.textContent = `
    ...
    #${PANEL_ID} .ss-reals2f-pair-head .ss-reals2f-pair-bad { color: #64748b; }
  ...
  const pairTitle = el("div", "ss-reals2f-pair-title", "Gatilhos (indicações)");
  const pairBoard = el("div", "ss-reals2f-pairs");
  const pairHead = el("div", "ss-reals2f-pair-head");
  pairHead.append(el("span"), el("span", "ss-reals2f-pair-ok", "OK"), el("span", "ss-reals2f-pair-bad", "ERR"));
  ...
  for (const [id, label] of PAIR_IDS) {
    ...
    row.append(el("span", "ss-reals2f-pair-id", label), okEl, badEl);
