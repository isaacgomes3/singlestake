...
var SinglestakeReals2f = (() => {
  ...
  var REALS2F_PAIR_IDS = new Set(getIce2fComparePairs().map((p) => p.id));
  ...
  function createReals2fEngine(options = {}) {
    ...
    function buildBridgePayload(mesaEmbedUrl = REALS2F_MESA_URL) {
      ...
      const signalId = `reals2f:pos${active.criticalPosition}:${active.axis}:ref${active.referenceNumber}:r${recovery}`;
