...
var SinglestakeSportingbet2f = (() => {
  ...
  var SPORTINGBET2F_PAIR_IDS = new Set(getIce2fComparePairs().map((p) => p.id));
  ...
  function createSportingbet2fEngine(options = {}) {
    ...
    function buildBridgePayload(mesaEmbedUrl = SPORTINGBET2F_MESA_URL) {
      ...
      const signalId = `sportingbet2f:pos${active.criticalPosition}:${active.axis}:ref${active.referenceNumber}:r${recovery}`;
