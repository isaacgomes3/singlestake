...
function pageIsSportingbet2fRoulette() {
  ...
  style.textContent = `
    ...
    #${PANEL_ID} .ss-sportingbet2f-pair-head .ss-sportingbet2f-pair-bad { color: #64748b; }
  ...
  const pairTitle = el("div", "ss-sportingbet2f-pair-title", "Gatilhos (indicações)");
  const pairBoard = el("div", "ss-sportingbet2f-pairs");
  const pairHead = el("div", "ss-sportingbet2f-pair-head");
  pairHead.append(el("span"), el("span", "ss-sportingbet2f-pair-ok", "OK"), el("span", "ss-sportingbet2f-pair-bad", "ERR"));
  ...
  for (const [id, label] of PAIR_IDS) {
    ...
    row.append(el("span", "ss-sportingbet2f-pair-id", label), okEl, badEl);
