...
(function () {
  const PROFILES = {
    ...
    low: {
      ...
      dataHints: ["low", "LOW", "1-18", "1_18", "rl_low"],
      classHints: ["rl_low", "bet-low", "outside-low", "1-18"],
    },
    high: {
      textHints: ["19-36", "19–36", "alto", "high"],
      dataHints: ["high", "HIGH", "19-36", "19_36", "rl_high"],
      classHints: ["rl_high", "bet-high", "outside-high", "19-36"],
    },
    "doz:1": {
  ...
  function isPragmaticContext() {
    ...
    return (
      ...
      (h.includes("ice.bet.br") && h.includes("/games/"))
    );
  }
