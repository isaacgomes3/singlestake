...
function pageIsBn2fRoulette() {
  ...
  style.textContent = `
    ...
    #${PANEL_ID} .ss-bn2f-pair-head .ss-bn2f-pair-bad { color: #64748b; }
  ...
  const pairTitle = el("div", "ss-bn2f-pair-title", "Gatilhos (indicações)");
  const pairBoard = el("div", "ss-bn2f-pairs");
  const pairHead = el("div", "ss-bn2f-pair-head");
  pairHead.append(el("span"), el("span", "ss-bn2f-pair-ok", "OK"), el("span", "ss-bn2f-pair-bad", "ERR"));
  ...
  for (const [id, label] of PAIR_IDS) {
    ...
    row.append(el("span", "ss-bn2f-pair-id", label), okEl, badEl);
