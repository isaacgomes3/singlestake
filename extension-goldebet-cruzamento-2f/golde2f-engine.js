...
var SinglestakeGolde2f = (() => {
  ...
  var GOLDE2F_PAIR_IDS = new Set(getIce2fComparePairs().map((p) => p.id));
  ...
  function createGolde2fEngine(options = {}) {
    ...
    function buildBridgePayload(mesaEmbedUrl = GOLDE2F_MESA_URL) {
      ...
      const signalId = `golde2f:pos${active.criticalPosition}:${active.axis}:ref${active.referenceNumber}:r${recovery}`;
